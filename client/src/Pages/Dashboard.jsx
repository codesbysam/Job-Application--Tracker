...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    // Load the real jobs for this user from the backend (GET /api/jobs)
  ...
  // Count how many jobs are in each status, straight from real job data
    ...
    datasets: [
      {
        label: "Applications",
        data: [
          jobStatusCount.applied || 0,
          jobStatusCount.interview || 0,
